...
Public Class web_empty
    ...
    Public Overrides Function postBackProc(page As String, data As String, user As String, userRights As Integer) As String
        ...
        Select Case parts("id")
            ...
            Case "oButton1"
                Me.pageCommands.Add("executefunction", "OpenNewWindow('empty?id=1')")
    ...
    Public Function GetPagePlugin(ByVal pageName As String, ByVal user As String, ByVal userRights As Integer, ByVal queryString As String) As String
        ...
        Try
            ...
            CurrentPage = Me
            Me.AddHeader(" <script src=""js/jilles.NewWindow.js""></script>")
    ...
    Function BuildContent() As String
        ...
        stb.Append("  <tr><td class='tablecolumn' width='270'>this is empty page  with index" & index & "</td></tr>")
        stb.Append(" </table>")
        Return stb.ToString
    End Function
