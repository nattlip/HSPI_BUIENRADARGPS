...
Module utils
    ...
    Public Const IFACE_NAME As String = "BuienRadarGps"
    ...
    Public Sub RegisterWebPageWhitoutlink(ByVal link As String, Optional linktext As String = "", Optional page_title As String = "")
        Try
            hs.RegisterPage(link, IFACE_NAME, Instance)
            'If linktext = "" Then linktext = link
            'linktext = linktext.Replace("_", " ")
    ...
    '' this makes plgin titel vise.vble
    Public Sub RegisterPluginWebPage(ByVal link As String, Optional linktext As String = "", Optional page_title As String = "")
        ...
        If Instance <> "" Then
            wpd.linktext = "BuienRadar Plugin Config instance " & Instance
        Else
            wpd.linktext = "BuienRadar Plugin Config"
        End If

        wpd.page_title = "BuienRadar Plugin Config"
        wpd.plugInName = IFACE_NAME
