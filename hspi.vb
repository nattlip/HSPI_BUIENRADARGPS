...
Public Class HSPI
    ...
    Public Function InitIO(ByVal port As String) As String Implements HomeSeerAPI.IPlugInAPI.InitIO
        ...
        ''RegisterPluginWebPage(oPlugin.sRegisterConfigPage)
        ''  RegisterWebPage(oPlugin.sRegisterConfigPage)
        'RegisterWebPage(oPlugin.sConfigPage)
        'RegisterWebPage(oPlugin.sStatusPage)
        RegisterPluginWebPage(oPlugin.sBuienRadarPage)
        ''RegisterPluginWebPage(oPlugin.sConfigPage)
        '' RegisterWebPageWhitoutlink(oPlugin.sEmptyPage)

        HsDevice.Create_Hs3_IO_Device()

        BuienRadarGps.buienradar_timer.Interval = 30000 '10000   ' 1 uur  =   36000000 9000000 = kwartier '1 minuut = 60.000 30 sec = 30000
        BuienRadarGps.buienradar_timer.Enabled = True

        Files.CreateRainXdox()

        BuienRadarGps.BuienRadarWebSiteConnected = BuienRadarGps.CheckConnectionBuiennRadarGps()



        BuienRadarGps.buienradartimeraction()
